...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      auto_complete_expired_sells: {
        Args: Record<PropertyKey, never>
        Returns: number
      }
      calculate_pickup_deadline: {
        Args: { p_drop_date: string; p_location_id: string }
        Returns: string
      }
      change_drop_status: {
        Args: {
      ...
      reserve_drop_product_inventory: {
        Args: { p_drop_product_id: string; p_quantity: number }
        Returns: boolean
      }
      reserve_inventory: {
        Args: { p_date: string; p_product_id: string; p_quantity: number }
        Returns: boolean
      }
      ...
      reserve_sell_inventory: {
        Args: { p_product_id: string; p_quantity: number; p_sell_id: string }
        Returns: boolean
      }
      rollback_drop_enhancements: {
        Args: Record<PropertyKey, never>
        Returns: string
      }
      test_enhanced_drop_system: {
        Args: Record<PropertyKey, never>
        Returns: string
      }
    }
